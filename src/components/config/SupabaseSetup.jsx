...
export default function SupabaseSetup() {
  ...
  const handleGenerate = () => {
    ...
    if (selectedFields.length) {
      ...
      tableParts.push(`CREATE TABLE ${tableName} (\n  id bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,\n${cols}\n);`);
    }
      ...
      <CardContent className="space-y-4">
        <Tabs defaultValue="config">
          ...
          <TabsContent value="config" className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="tableName">اسم الجدول المخصص</Label>
              <Input id="tableName" value={tableName} onChange={e => setTableName(e.target.value)} placeholder="custom_table" className="glass-effect" />
            </div>
